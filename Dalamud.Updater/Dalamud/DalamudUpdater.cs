...
namespace XIVLauncher.Common.Dalamud
{
    ...
    public class DalamudUpdater
    {
        ...
        public const string REMOTE_BASE = "https://raw.githubusercontent.com/lee-jinhwan/Dalamud-Resources/";
        public const string REMOTE_VERSION = REMOTE_BASE + "main/VersionInfo_";
        public const string REMOTE_DOTNET = REMOTE_BASE + "main/runtime/{0}/dotnet-runtime-{0}-win-x64.zip";
        public const string REMOTE_DESKTOP = REMOTE_BASE + "main/runtime/{0}/windowsdesktop-runtime-{0}-win-x64.zip";
